...
execute_process(
  COMMAND "/opt/homebrew/bin/git" --git-dir=.git show-ref "release/1"
  WORKING_DIRECTORY "/Users/alexchen/Documents/GitHub/Battleship_FinalProject/cmake-build-debug/_deps/slint-src"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/Users/alexchen/Documents/GitHub/Battleship_FinalProject/cmake-build-debug/_deps/slint-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/Users/alexchen/Documents/GitHub/Battleship_FinalProject/cmake-build-debug/_deps/slint-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
